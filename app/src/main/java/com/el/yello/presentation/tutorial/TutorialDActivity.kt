...
class TutorialDActivity : BindingActivity<ActivityTutorialDBinding>(R.layout.activity_tutorial_d) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.root.setOnSingleClickListener {
            val targetActivityClass = if (viewModel.isCodeTextEmpty) {
                TutorialEndPlusActivity::class.java
            } else {
                TutorialEndActivity::class.java
            }
            val intent = Intent(this@TutorialDActivity, targetActivityClass)
