...
class ProfileViewModel : ViewModel() {
    ...
    fun addListFromLocal() {
        val mockList = listOf(
            ...
            ProfileFriendModel(8, "삼민주", "@sa_ng_ho__qdw","안드로이드안드로이드대 국희의콩나물국과 29학번", null, 30, 27),
            ...
            ProfileFriendModel(12, "칠민주", "@sa_ng_ho__qdw","안드로이드안드로이드대 국희의콩나물국과 29학번", null, 30, 27)
